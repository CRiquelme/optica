...
<div id="clientes" class="m-10">
  <div class="pb-5 mb-4" uk-grid>
    ...
    <div class="uk-width-1-6 pos_relative">
      <a class="uk-button uk-button-secondary uk-button-small  uk-text-middle uk-position-center"
        href="#modal-container" uk-toggle onclick="add_cliente()">Nuevo</a>
    </div>
  </div>
          ...
          <tr v-for="(cliente, index) in clientes" :key="cliente.id_cliente">
            ...
            <td>
              <div class="flex flex-row align-center justify-between">
                <a :href="'libro/'+cliente.id_cliente" class="text-black" title="Agregar al libro"><i
                    class="fas fa-book uk-margin-small-left uk-text-emphasis"></i></a>
                <a :href="'sobre/'+cliente.id_cliente" class="font-green-700" title="Agregar sobre"><i
                    class="far fa-envelope"></i></a>
                <button class="text-red-700" v-on:click="delete_cliente(index, cliente.id_cliente)"
                  v-bind:id="'delete-' + cliente.id_cliente" title="Eliminar"><i
                    class="fas fa-trash-alt uk-margin-small-left uk-text-danger"></i></button>
...
<div id="modal-container" class="uk-modal-container" uk-modal>
  <div class="uk-modal-dialog uk-modal-body">
    ...
    <h2
      class="uk-modal-title uk-form-stacked uk-padding-large uk-padding-remove-top uk-padding-remove-bottom uk-text-uppercase">
      Cliente</h2>
